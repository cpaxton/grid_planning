  ...
  std::unordered_map<std::string, SkillPtr> loadSkills(const std::string &ee) {
    ...
    /* LOAD TRAINING DATA FOR APPROACH */
    {
      std::string filenames[] = {
        "data/ur5_assembly_v2/approach_link_x_11.bag",
        "data/ur5_assembly_v2/approach_link_x_12.bag",
        "data/ur5_assembly_v2/approach_link_x_13.bag",};
    ...
    {
      std::string filenames[] = {
        "data/ur5_assembly_v2/grasp_link_x_11.bag", 
        "data/ur5_assembly_v2/grasp_link_x_12.bag", 
        "data/ur5_assembly_v2/grasp_link_x_13.bag",};
