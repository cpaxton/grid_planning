...
if __name__ == "__main__":
    ...
    dbg_link = PoseArray()
    dbg_node = PoseArray()
    dbg_ee_poses.header.frame_id = 'filtered/camera_2/ar_marker_1'
    dbg_ee_poses2.header.frame_id = 'filtered/camera_2/ar_marker_2'
    ...
    for filename in filenames:
        ...
        demo = grid.LoadRobotFeatures(filename,preset="ur5_with_joint_limits");
    ...
    for (demo, fx) in data:
        ...
        dbg_link_ = demo.GetWorldPoseMsg("tool")
        #dbg_node_ = demo.get_world_pose_msg("node")
        dbg_node_ = demo.GetWorldPoseMsg("vise")
    ...
    pa_pub = rospy.Publisher('/dbg_ee_tool',PoseArray)
    pa2_pub = rospy.Publisher('/dbg_ee_vise',PoseArray)
    pa_ee_pub = rospy.Publisher('/dbg_ee',PoseArray)
    pa_link_pub = rospy.Publisher('/dbg_tool',PoseArray)
    pa_node_pub = rospy.Publisher('/dbg_vise',PoseArray)
