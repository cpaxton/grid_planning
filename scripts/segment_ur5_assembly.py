...
if __name__ == "__main__":
    ...
    dbg_link = PoseArray()
    dbg_node = PoseArray()
    dbg_ee_poses.header.frame_id = 'Obj::link_uniform::1'#'filtered/camera_2/ar_marker_1'
    dbg_ee_poses2.header.frame_id = 'Obj::node_uniform::1'#'filtered/camera_2/ar_marker_2'
    ...
    for (demo, fx) in data:
        ...
        dbg_ee_poses_ = grid.GetPoseMessage(fx,8,'Obj::link_uniform::1')
        dbg_ee_poses2_ = grid.GetPoseMessage(fx,0,'Obj::node_uniform::1')
